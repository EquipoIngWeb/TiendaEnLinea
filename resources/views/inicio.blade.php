...
<!-- for-mobile-apps -->
    ...
    <!-- //js -->
    <!-- cart -->
    <script src="jss/simpleCart.min.js"></script>
        ...
        <div class="container">
            <div class="banner-info animated wow zoomIn" data-wow-delay=".5s">
                ...
                <div class="wmuSlider example1">
                    ...
                    <script src="jss/jquery.wmuSlider.js"></script> 
                    <script>
                        $('.example1').wmuSlider();         
                    </script> 
            </div>
        ...
        <div class="container">
            <div class="timer-grids">
                <div class="col-md-8 timer-grid-left animated wow slideInLeft" data-wow-delay=".5s">
                    ...
                    <div id="counter"> </div>
                    <script src="jss/jquery.countdown.js"></script>
    ...
    <div class="footer">
        <div class="container">
            ...
            <div class="footer-logo animated wow slideInUp" data-wow-delay=".5s">
                <h2><a href="index.html">Lara - Shop <span>Todo lo que necesites al tu alcance</span></a></h2>
            </div>
            <div class="copy-right animated wow slideInUp" data-wow-delay=".5s">
                <p>&copy 2016 Lara - Shop. Derechos Reservados | Diseñado por <a href="http://w3layouts.com/">JARVR</a></p>
            </div>
        </div>
    </div>
<!-- //footer -->
